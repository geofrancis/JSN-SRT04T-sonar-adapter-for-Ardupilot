...
void readsonar1(){     
    ...
    if (readIndex >= Sample_number) {
       // ...wrap around to the beginning:
       readIndex = 0;
  }

      // calculate the average:
      average = total / Sample_number;
...
void readsonar2(){  
    ...
    if (portTwo.read() == 0xff) {
      ...
      if (data_buffer2[3] == CS2) {
       ...
       // if we're at the end of the array...
    if (readIndex2 >= Sample_number) {
       // ...wrap around to the beginning:
       readIndex2 = 0;
  }

      // calculate the average:
      average2 = total2 / Sample_number;
...
void readsonar3(){     
    ...
    if (Serial.read() == 0xff) {
      ...
      if (data_buffer3[3] == CS3) {
       ...
       // if we're at the end of the array...
    if (readIndex3 >= Sample_number) {
       // ...wrap around to the beginning:
       readIndex3 = 0;
  }

      // calculate the average:
      average3 = total3 / Sample_number;
...
void setup() {
 ...
 for (int thisReading = 0; thisReading < Sample_number; thisReading++) {
    readings[thisReading] = 0;
  for (int thisReading2 = 0; thisReading2 < Sample_number; thisReading2++) {
    readings2[thisReading2] = 0;
  for (int thisReading3 = 0; thisReading3 < Sample_number; thisReading3++) {
